        ...
        function Section:AddDropdown(text, options, isMulti, callback)
            ...
            for i, optName in ipairs(options) do
                ...
                OptBtn.MouseEnter:Connect(function() 
                    if not Dropdown.Selected[optName] then OptBtn.TextColor3 = Interface.Theme.TextActive end
                end)
                OptBtn.MouseLeave:Connect(function() 
                    if not Dropdown.Selected[optName] then OptBtn.TextColor3 = Interface.Theme.TextInactive end
                end)
            end
